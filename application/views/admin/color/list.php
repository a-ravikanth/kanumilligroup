                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($post->status == "0")
                                            ...
                                            ?></td>
                                         <td>
                                            <a class="btn btn-default btn-rounded btn-condensed btn-sm" type="button" data-toggle="tooltip"  title="Edit" href="<?=site_url('account/edit-color/'.$post->id)?>"><i class="fa fa-pencil"></i></a>
                                            <a href="<?= base_url() . 'account/color-delete/' . $post->id ?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Delete" ><span class="fa fa-times" title="delete"></span></a>
                                         </td>
