                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <tbody>
                                    <?php foreach ($eq_list as $post)
                                    { ?>
                                    <tr>
                                        <td style="text-transform: capitalize;"><?= $post->eq_product_name;?></td>
                                        <td><?= $post->eq_qty?></td>
                                        ...
                                        <td><?= $post->created_date?></td>
                                         <td>
                                            ...
                                            <a href="<?= base_url() . 'account/enquiry-delete/' . $post->eq_id ?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Delete" ><span class="fa fa-times" title="delete"></span></a>
                                         </td>
