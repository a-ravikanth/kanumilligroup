                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $post->product_name?>&nbsp;&nbsp;<a href="javascript:" class="btn-sm editField" data-toggle="tooltip"  data-placement="top" title="Edit Name" data-product_id="<?= $post->id?>" data-href="<?=site_url('account/signle-product-edit')?>" data-type="product_name"><span class="fa fa-pencil"></span></a></td>
                                        ...
                                        ?>
                                        &nbsp;&nbsp;<a href="javascript:" class="btn-sm editField" data-toggle="tooltip"  data-placement="top" title="Edit Categort" data-product_id="<?= $post->id?>" data-href="<?=site_url('account/signle-product-edit')?>" data-type="product_category"><span class="fa fa-pencil"></span></a></td>
                                        <td><?= $post->product_description?>&nbsp;&nbsp;<a href="javascript:" class="btn-sm editField" data-toggle="tooltip"  data-placement="top" title="Edit Description" data-product_id="<?= $post->id?>" data-href="<?=site_url('account/signle-product-edit')?>" data-type="product_description"><span class="fa fa-pencil"></span></a></td>
