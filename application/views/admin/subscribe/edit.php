                                      ...
                                      <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <input class="form-control" type="text" id="product_name" value="<?=$post->size;?>" name="size_name" placeholder="Size Name" >
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-2">
                                                <button class="btn btn-sm btn-primary" name="submit" type="submit"><i class="fa fa-check"></i> Update Size</button>
                                            </div>
                                        </div>
                                    </form>
                                    <?php }?>
